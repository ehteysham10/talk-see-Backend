...
const FROM_EMAIL = 'Talk&See <onboarding@resend.dev>';
      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            ...
            <p>You requested to reset your password. Use the OTP below to set a new password. This OTP is valid for 5 minutes.</p>
